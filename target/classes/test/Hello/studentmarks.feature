...
Feature: Student marks sheet
  ...
  Scenario: To print student mark sheet pass / fail
    Given the student subject mark list "C:\\Users\\Reddy\\Documents\\Book1.xlsx"
    When printed the mark list where the condition is if percentage is >90% then pass and <90% is fail
